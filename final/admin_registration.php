...
if($emailcount>0){ //$emailcount>0 means even if single same email exist then you will get mssg already exist
  ...
  if($password === $repassword){
    ...
    $insertquery = "INSERT INTO `admin_registration`(`username`,`email`,`password`,`phone`,`address`,`dateOfBirth`,`gender`)
      ...
      <form id="form1" action="" method="post">
        ...
        <div class="login-signup">
          <label for="link" class="text">Already registered?
            <a href="admin_login.php" class="text signup-link">Login</a>
          </label>
        </div>
