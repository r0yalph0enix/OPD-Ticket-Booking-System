...
form.addEventListener("submit", (e) => {
    if (!(validUserName==true && validEmail==true && validAddress==true && validPhone==true && validPassword==true && confirmPassword==true && validDateOfBirth && validDegree && validSpeciality)) {
        e.preventDefault();
