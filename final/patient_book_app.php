...
<div class="login" style="background-color:#fff;">
    ...
    <div class="formstyle" style="float: right;padding: 50px;border: 1px solid lightgrey;margin-right:415px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
...
?>
            <label>
                Patien Id: <input type="text" name="pid" value="<?php echo $result['id']; ?>"  >
            </label><br><br>
                Your Name: <input type="text" name="pname" value="<?php echo $result['username']; ?>">
            </label><br><br>

            <label>
                Phone: <input type="text" name="pcontact" value="<?php echo $result['phone']; ?>" >
            </label><br><br>
            <label>
                Reason: <input type="text" name="preason" value="" >
            </label><br><br>
            <label>
                E-mail: <input type="email" name="email" value="<?php echo $result['email']; ?>" >
            </label><br><br>
           ...
           Appointment Time: <input type="time" name="appointmenttime" value="<?php echo $time; ?>">
            ...
            <button name="submit" type="submit" style="padding-right:13px;border-radius:3px;">Confirm</button>
