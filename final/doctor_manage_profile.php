...
if (isset($_POST['submit'])) {
  ...
  $valid = "select * from doctor where   doctorname = '$doctorname'  AND degree = '$degree'  AND specialist = '$speciality' AND dateOfBirth = '$dateOfBirth' ";
 ...
 $updatequery =  " update doctor set doctorname='$doctorname', email='$email', password='$password', phone='$phone', address='$address', degree='$degree', specialist='$speciality', dateOfBirth='$dateOfBirth' where id = $id " ;
...
?>
          ...
          <div class="input-box">
            ...
            <input type="text" id="txtDegree" class="form-control" placeholder="Enter your degree" name="degree"  value="<?php echo $result['degree']; ?>" >
